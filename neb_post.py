...
class NEBPost():
    ...
    def __init__(self, traj_file, n_images):
        self.all_image = read(traj_file, index=":", format="traj")
        self.neb_chain = read(traj_file, index=f"{- n_images}:", format="traj")
    ...
    def get_barrier(self):
        ...
        return NEBTools(self.neb_chain).get_barrier()
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        result = NEBPost(traj_file, n_images)
        result.get_barrier()

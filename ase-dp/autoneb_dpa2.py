...
autoneb = AutoNEB(attach_calculators, prefix=prefix, n_simul=n_simul, n_max=n_max+2, fmax=[0.20,0.05], climb=True, method="improvedtangent", smooth_curve=True, parallel=False, optimizer=FIRE)
autoneb.run()
